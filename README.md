...
Team members: 1) Siddhesh Sawant - 002058340
              2) Shubham Bagwe - 002057120
              3) Omkar Salian - 002050108
...
3. Import the Project into Eclipse
 ...
 File > Import > Existing Projects into Workspace.
   3. Select the StayMaster directory as the root directory.
...
5. Add JARs and Libraries to the Class Path
...
7. Configure JavaFX
   ...
   5. Point the configuration to the JavaFX SDK's lib directory.
 Example path: /path/to/javafx-sdk/lib
...
Ensure the main class is specified, and the JavaFX module path is added under VM arguments if necessary.
   Example VM arguments for JavaFX:
      --module-path "/Users/siddheshsawant/PSA/Project/StayMaster/javafx-sdk-23.0.1/lib" --add-modules javafx.controls,javafx.fxml

Also, un-check the below box in Arguments in run Configurations
 Use the -XstartOnFirstThread argument when launching with SWT

Note: Project works best with JDK 23 and JavaFX 23
