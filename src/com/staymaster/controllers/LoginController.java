...
public class LoginController {
	...
	private void handleSignInButton(ActionEvent event) throws IOException {
		...
		if (email.equals("admin") && password.equals("Admin@1234")) {
			// Admin login
			NavigationManager.navigateTo("/com/staymaster/views/AdminPortal.fxml", "Admin Portal");
		} else {
			// Regular user login
	...
	private void handleSignUpButton(ActionEvent event) {
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/staymaster/views/UserSignUp.fxml"));
